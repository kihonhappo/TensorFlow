...
This file is the heavy lifter for the machine learning portion of the application. 
This module trains the tensor models 

*/

export const trainModel = async function (X, Y, window_size, n_epochs, learning_rate, n_layers, callback) {
...
export const makePredictions = function (X, model, dict_normalize)
{
